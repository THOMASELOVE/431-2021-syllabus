---
title: "431 Syllabus for Fall 2021"
...
- There are nine [teaching assistants][Teaching Assistants] helping with the course this semester.
...
- The [431 Syllabus](https://thomaselove.github.io/431-2021-syllabus/) (this document)
- Dr. Love's [Course Notes](https://thomaselove.github.io/431-notes/)
- The [Course Calendar](https://thomaselove.github.io/431/calendar.html), which is the final word for all deadlines and assignments
    - The [Calendar](https://thomaselove.github.io/431/calendar.html) also links to materials for each class, including presentation slides and announcements
...
- Our [Piazza discussion forum](https://piazza.com/case/fall2021/pqhs431/home) for questions and answers
- Our [Canvas page](https://canvas.case.edu) for turning in assignments and downloading recordings.
- A [Contact Us page](https://thomaselove.github.io/431/contact.html) where you can get complete information about how to get help in this course from Dr. Love and the Teaching Assistants.

# Getting Started

## Before our First Class

Most of you have already accessed [the pre-class website](https://431-2021-preclass-love.netlify.app/). Once class begins, that will no longer be relevant, and will be replaced by [our main course website](https://thomaselove.github.io/431/) and (among other things) this Syllabus. If you're seeing this before class starts on 2021-08-24, then make sure that you:
...
2. Review [the pre-class website](https://431-2021-preclass-love.netlify.app/) closely. The most important needs initially are completing the [Welcome to 431 survey](https://bit.ly/431-2021-welcome-survey), obtaining [the books][Required Texts] you'll need, and [the software][Getting the Software] you'll need to install. 
3. Review [CWRU's Knowledge Base for Zoom](https://case.edu/utech/help/knowledge-base/zoom/zoom-information) to ensure you can join office hours (once they begin) through your CWRU Zoom account. 
...
Many of you will complete this before class begins, but if you haven't, please fill out the [Welcome to 431 Survey](https://bit.ly/431-2021-welcome-survey) at https://bit.ly/431-2021-welcome-survey to help us get to know you a little better.
...
- We will use [Piazza](https://piazza.com/case/fall2021/pqhs431/home) this semester to facilitate questions and answers. We'll be conducting all class-related discussion there, instead of via email.
- Find our class page at: https://piazza.com/case/fall2021/pqhs431/home. If you're successfully enrolled in the class, you should be able to sign up immediately.
    ...
    - We will use Piazza for all questions **except** questions about [Quizzes][Quizzes]. We'll give you special instructions for Quizzes.
...
- The schedule for TA office hours appears on the [Course Calendar](https://thomaselove.github.io/431/calendar.html), and on our [Contact Us](https://thomaselove.github.io/431/contact.html) page.
...
- Remember that questions about course materials are best asked through [Piazza](https://piazza.com/case/fall2021/pqhs431/home) or at TA Office Hours.
...
- Professor Love uses he/him/his pronouns, and identifies as male.
    - Most students refer to him either as Professor Love or Dr. Love, and he prefers this in class.
...
- At Github, he is [THOMASELOVE](https://github.com/THOMASELOVE).
    - The Github repository [for this syllabus is here](https://github.com/THOMASELOVE/431-2021-syllabus).
...
- [Dipak Upadhyaya][Dipak Upadhyaya], PhD student in Biomedical Health Informatics
- [Yanning Wu][Yanning Wu], PhD student in Epidemiology \& Biostatistics

## TA office hours

TA office hours are held via Zoom, will begin on 2021-08-29 and end on 2021-12-05. The weekly schedule is found on the [Contact Us](https://thomaselove.github.io/431/contact.html) page and on the [Course Calendar](https://thomaselove.github.io/431/calendar.html).
...
Dr. Love maintains a set of [Course Notes](https://thomaselove.github.io/431-notes/), titled **Data Science for Biological, Medical and Health Research: Notes for 431.** Professor Love revises the Notes every year, and so they appear in pieces as the semester progresses.
...
2. [R for Data Science](https://r4ds.had.co.nz/) by Garrett Grolemund and Hadley Wickham.
3. [Biostatistics for Biomedical Research](http://hbiostat.org/doc/bbr.pdf) (pdf) by Frank E. Harrell Jr and James C Slaughter. This is regularly updated by the authors, as indicated on [their course website](https://hbiostat.org/bbr/), so get the most recent version occasionally.
...
Many of these resources will come up again in class, but no one can keep up with all of this material. Pick things that interest you to follow up with. And I'm always eager to receive additional suggestions from students in the class. If you find a helpful resource, please suggest it to us on [Piazza](https://piazza.com/case/fall2021/pqhs431/home).
...
4. [R Programming for Data Science](https://leanpub.com/rprogramming) by Roger D. Peng. An earlier edition is available at [bookdown](https://bookdown.org/rdpeng/rprogdatascience/)
5. [R Markdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/) by Yihui Xie, J. J. Allaire, and Garrett Grolemund
6. [R Markdown for Scientists](https://rmd4sci.njtierney.com/) by Nicholas Tierney
7. [R Packages](https://r-pkgs.org/) by Hadley Wickham and Jenny Bryan
8. [What They Forgot to Teach You About R](https://whattheyforgot.org/) by Jenny Bryan and Jim Hester
9. [Advanced R](https://adv-r.hadley.nz/) by Hadley Wickham (2nd edition)
10. [Hands-On Programming with R](https://rstudio-education.github.io/hopr/) by Garrett Grolemund
...
1. I recommend the [Community-Sourced Data Science Guide](https://github.com/Chris-Engelhardt/data_sci_guide) to find more resources for learning data science.
...
1. [Resources from RStudio](https://resources.rstudio.com/) is a great source of all kinds of useful stuff. For example:
  ...
  - [RStudio Webinars](https://resources.rstudio.com/webinars) on a variety of subjects.
...
1. [Broadening Your Statistical Horizons: Generalized Linear Models and Multilevel Models](https://bookdown.org/roback/bookdown-BeyondMLR/) by Paul Roback and Julie Legler
...
3. [An Introduction to Statistical Learning with Applications in R](https://www.statlearning.com/) by Gareth James, Daniela Witten, Trevor Hastie and Robert Tibshirani
...
3. Install some **R packages** - an R "package" is a collection of functions, data, and documentation that extends the capabilities of R, and is the critical way to get R doing interesting work. 
    - Details on installing key packages we will use in 431 are [on the Packages page](https://thomaselove.github.io/431/r_packages.html), and that's also where you'll find an updated list of packages you'll need in the course.
...
- If you're having installation problems or problems getting started in R, please consider visiting TA office hours or perhaps asking a question on [Piazza](https://piazza.com/case/fall2021/pqhs431/home). We want to hear from you!
...
5. **Attendance** is expected, but it is also expected that sometimes life will intervene. All students are expected to attend all class sessions in compliance with University policies.
    - If you need to miss **more than two** classes in a row, inform Professor Love via email beforehand, or as soon as possible thereafter. I will assume you have a good reason - details are **not** necessary.
...
12. **Audio-Recording.** It is our intention to provide audio recordings of each class after they are complete. You should assume that anything you say *will* be recorded.
13. **Typos.** Professor Love makes occasional typographic and grammatical errors, which irritate him enormously. Please post to [Piazza](https://piazza.com/case/fall2021/pqhs431/home) the details of any typos or errors you find in this syllabus or any other course materials. If you are the first to let us know, and we make the change, you will receive some credit in your class participation grade.
...
By now, you're probably familiar with Zoom. We ask that you review [the CWRU Knowledge Base for Zoom](https://case.edu/utech/help/knowledge-base/zoom/zoom-information) and get familiar with your Zoom account.
...
- 25 points for completing the [Welcome to 431  survey](https://bit.ly/431-2021-welcome-survey) that most of you did prior to class, and if you haven't done it, please do so now.
...
- asking especially helpful questions in the Minute Papers or on [Piazza](https://piazza.com/case/fall2021/pqhs431/home)
- providing helpful responses to questions on [Piazza](https://piazza.com/case/fall2021/pqhs431/home)
- identifying interesting visualizations or uses of ideas we're discussing in class in the popular or scientific media (this is also done via [Piazza](https://piazza.com/case/fall2021/pqhs431/home))
...
2. Contribute to [Piazza](https://piazza.com/case/fall2021/pqhs431/home) with questions, answers and helpful comments. That'll help us recognize you as someone trying to improve their understanding.
  - If you find **typos** in the materials (code, slides, the Notes, this syllabus) send them to us on [Piazza](https://piazza.com/case/fall2021/pqhs431/home). 
  - See a cool visualization online (of anything other than COVID-19 data)? A nice use of statistical methods or design in a paper? Share them with us on [Piazza](https://piazza.com/case/fall2021/pqhs431/home).
...
3. You are welcome to discuss each Lab with anyone, including Professor Love, the teaching assistants, or your colleagues, but your answer must be prepared by you alone. We especially encourage you to take advantage of TA office hours and [Piazza](https://piazza.com/case/fall2021/pqhs431/home).
...
During the semester, you will have three quizzes to complete. See the [Course Calendar](https://thomaselove.github.io/431/calendar.html) for deadlines, and the [Course Quiz page](https://github.com/THOMASELOVE/431-2021/tree/main/quizzes) for other details.

Each quiz is taken online via a Google Form (like the Minute Papers or the [Welcome to 431 survey](https://bit.ly/431-2021-welcome-survey).) Each quiz includes both short-answer and multiple-choice items. The quizzes focus on whether you can apply the tools developed in class to address small problems.
...
As we've discussed, for most of the course, [Piazza](https://piazza.com/case/fall2021/pqhs431/home) will be our tool for asking and answering questions. 
...
For more information on the Projects, please visit the Assignments section of  [our main course web site](https://thomaselove.github.io/431/).
...
Visit https://case.edu/covid19/covid-19-communications for recent messages to the CWRU community.
