...
- Professor Love best reached via email in an emergency.
...
- Zoom links to TA office hours will appear in the [Announcements section on Canvas](https://canvas.case.edu) by 2021-08-27.
...
3. Install some **R packages** - an R "package" is a collection of functions, data, and documentation that extends the capabilities of R, and is the critical way to get R doing interesting work. 
    - Details on installing key packages we will use in 431 are [on the Packages page](packages.html), and that's also where you'll find an updated list of packages you'll need in the course.
